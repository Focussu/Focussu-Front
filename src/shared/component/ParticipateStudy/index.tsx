...
export default function ParticipateStudy() {
  return (
    <div className="bg-white border-0 rounded-lg w-[420px] h-[465px]">
      <div className="font-semibold text-[15px] mt-[16px] ml-[25px]">
        내가 참여중인 스터디
      </div>
      <div className="w-[390px] border-t-1 mt-[10px] ml-[18px]"></div>
