  ...
  return (
    <div className="bg-[#E6E6E6] w-[1440px] h-[780px] flex justify-center items-center">
      <div className="w-[480px] h-[660px] bg-white rounded-lg flex flex-col">
        <div className="mx-[15px] mt-[15px] pb-[15px] px-[10px] border-b-1 text-black font-bold text-[15px]">
          회원가입
        </div>
        <div className="flex flex-col gap-[25px] mx-[25px] mt-[22px]">
          ...
          <button className="bg-black text-white text-[20px] py-[10px] mt-[10px] rounded-lg">
            회원가입 하기
          </button>
        </div>
      </div>
